...
<body class="d-flex flex-column">
    <main class="flex-shrink-0 bg-danger">
        <div class="container-fluid py-3 tk-bgvisi" style="background-image: url('assets/forHistory.png'); background-size: cover; background-position: center; background-repeat: no-repeat; height: 110vh;">
        ...
        <section class="bg-light py-5">
            ...
            <div class="container my-5 px-5">
                <div class="row text-left justify-content-start mb-3">
                    <h1 class="display-5 fw-bolder mb-0"><span class="text-gradient d-inline f-brandSchool">Sejarah</span></h1>
    ...
    <div class="container my-5">
        <div class="row text-end justify-content-end pb-5">
            <h1 class="display-5 fw-bolder"><span class="text-gradient d-inline f-brandSchool">Timeline King's Kidz</span></h1>
    ...
    <section class="py-5 bg-light">
        <div class="container px-5">
            <div class="text-center mb-5">
                <h1 class="display-5 fw-bolder mb-0"><span class="text-gradient d-inline f-brandSchool">Founder</span></h1>
            </div>
            <div class="row gx-5 justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="px-5">
                            ...
                            <div class="text-muted f-plus-jakarta">
                ...
                <div class="col-md-4 d-flex justify-content-center">
                    <div class="card shadow border-0" style="width: 18rem;">
                        <img class="card-img-top img-fluid rounded" src="assets/image/Bu_RutJulia.png" alt="Founder TK King's Kidz">
                        <div class="card-body">
                            <!-- Anda dapat menambahkan konten tambahan di sini jika diperlukan -->
                        </div>
                    </div>
                </div>
            </div>
